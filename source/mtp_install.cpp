...
constexpr const char* kStreamTracePath = "sdmc:/switch/HappyFoil/mtp_install_debug.log";
constexpr const char* kStreamTraceEnablePath = "sdmc:/switch/HappyFoil/mtp_install_debug.enable";
